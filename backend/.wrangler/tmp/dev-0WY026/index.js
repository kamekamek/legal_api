...
// .wrangler/tmp/bundle-hzhKo6/checked-fetch.js
...
// .wrangler/tmp/bundle-hzhKo6/middleware-loader.entry.ts
init_checked_fetch();

// .wrangler/tmp/bundle-hzhKo6/middleware-insertion-facade.js
init_checked_fetch();
...
var initSupabase = /* @__PURE__ */ __name((env2) => {
  return createClient(env2.SUPABASE_URL, env2.SUPABASE_ANON_KEY);
}, "initSupabase");
router.get("/api/projects", async (request, env2) => {
  try {
    const supabase = initSupabase(env2);
